...
@endphp
@once
    <link href="{{ secure_asset('vendor/bladewind/css/filepond.css') }}" rel="stylesheet"/>
    @if($hasImageFiles)
    <link href="{{ secure_asset('vendor/bladewind/css/filepond-plugin-image-preview.css') }}" rel="stylesheet"/>
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-image-exif-orientation.js') }}"></x-bladewind::script>
    <link href="{{ secure_asset('vendor/bladewind/css/cropper.min.css') }}" rel="stylesheet">
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/cropper.min.js') }}"></x-bladewind::script>
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-image-crop.js') }}"></x-bladewind::script>
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-image-preview.js') }}"></x-bladewind::script>
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-image-resize.js') }}"></x-bladewind::script>
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-image-transform.js') }}"></x-bladewind::script>
    @endif
    @if($validateFileSize)
        <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-file-validate-size.js') }}"></x-bladewind::script>
        @if($hasImageFiles)<x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-image-validate-size.js') }}"></x-bladewind::script>@endif
    @endif
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-file-encode.js') }}"></x-bladewind::script>
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond-plugin-file-validate-type.js') }}"></x-bladewind::script>
    <x-bladewind::script :nonce="$nonce" src="{{ secure_asset('vendor/bladewind/js/filepond.min.js') }}"></x-bladewind::script>
